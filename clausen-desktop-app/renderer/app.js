    ...
    renderStudentsTable(filter = '') {
        ...
        tbody.innerHTML = filteredStudents.map(student => `
            <tr>
                ...
                <td class="actions">
                    <button class="btn-icon" title="View" onclick="app.viewStudent('${student.id}')"><span>👁️</span></button>
                    <button class="btn-icon" title="Edit" onclick="app.editStudent('${student.id}')"><span>✏️</span></button>
                    <button class="btn-icon" title="Delete" onclick="app.deleteStudent('${student.id}')"><span>🗑️</span></button>
                </td>
            </tr>
        `).join('');
    }
    ...
    renderEmployeesTable(filter = '') {
        ...
        tbody.innerHTML = filteredEmployees.map(employee => `
            <tr>
                ...
                <td class="actions">
                    <button class="btn-icon" title="View" onclick="app.viewEmployee('${employee.id}')"><span>👁️</span></button>
                    <button class="btn-icon" title="Edit" onclick="app.editEmployee('${employee.id}')"><span>✏️</span></button>
                    <button class="btn-icon" title="Delete" onclick="app.deleteEmployee('${employee.id}')"><span>🗑️</span></button>
                </td>
            </tr>
        `).join('');
    }
